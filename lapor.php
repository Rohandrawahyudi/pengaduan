...
<head>
    ...
    <title>Lapor | Pemerintahan Nagari Tanjung Bonai Aur</title>
            ...
            <div class="row">
                <div class="col-md-8 card-shadow-2 form-custom">
                    <form class="form-horizontal" role="form" method="post" action="private/validasi" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="bukti" class="col-sm-3 control-label">Bukti Pengaduan (Gambar)</label>
                            <div class="col-sm-9">
                                <input type="file" id="bukti" name="bukti" accept="images/*" required>
                                <p class="error"><?= @$_GET['buktiError'] ?></p>
                            </div>
                        </div>
                        <div class="form-group">

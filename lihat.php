...
if(isset($_POST['submit'])) {
    ...
    if ($is_valid) {
        $statement = $db->query("SELECT * FROM laporan WHERE laporan.id = $nomor");
...
<head>
    ...
    <title>Lihat Pengaduan | Pemerintahan Nagari Tanjung Bonai Aur</title>
...
<body>
    ...
    <div class="shadow">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index">
                        <img alt="Brand" src="images/removebg-.png" style = "width:50px; margin-top: 0px;">
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="profil">Profil Dinas</a></li>
                                <li class="divider"></li>
                                ...
                                <div class="media-body">
                                    ...
                                    // dijalankan ketika $cari bernilai false // tanggapan tidak ditemukan
                                        ...
                                        if($key['status']=="Menunggu"){
                                            echo '<div class="alert alert-success" style="border:1px solid #32a863ff; border-radius:5px; padding:10px; margin-top:10px;">
                <b>Status Laporan :</b> Belum Diproses
              </div>';    
                                        }else if($key['status']=="diproses"){
                                            echo '<div class="alert alert-success" style="border:1px solid #32a863ff; border-radius:5px; padding:10px; margin-top:10px;">
                <b>Status Laporan :</b> Sedang Diproses
              </div>';    
                                        }else{
                                    }}
                                    ?>
        ...
        <div class="footer footer-bottom text-center">
            <div class="row">
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <p class="mb-0">
                    Jalan simpang 4 Tanjung Bonai Aur
                        <br>Sijunjung, Sumatera Barat
                    </p>
                </div>
                <div class="col-md-4 mb-5 mb-lg-0">
                    <ul class="list-inline mb-0">
                ...
                <div class="col-md-4">
                    ...
                    <p class="mb-0">
                        031-3095331 <br>
                        pemerintahan@Tanjungbonaiaur.go.id <br>
                        pemerintahan.tanjungbonaiaur@gmail.com
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container">
                <small>Copyright &copy; Pemerintahan Desa 2025</small>
            </div>
        </div>

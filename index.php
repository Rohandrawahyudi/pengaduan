...
<head>
    ...
    <title>KANTOR WALI NAGARI TANJUNG BONAI AUR</title>
    ...
    <div id="mainCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/slider.jpeg" alt="..." style="height: 500px;">
                <div class="carousel-caption welcome">
                    <h2 class="animated bounceInRight">Selamat Datang</h2>
                    <h3 class="animated bounceInLeft">Website Pengaduan Dan Keluhan Masyarakat Nagari Tanjung Bonai Aur</h3>
                </div>
            </div>
            <div class="item">
                <img src="images/baru.png" alt="...">
                <div class="carousel-caption">
                    <h2 class="animated bounceInDown">Pemerintah Nagari</h2>
                </div>
            </div>
        </div>
    ...
    <footer class="footer text-center">
        <div class="row">
            <div class="col-md-4 mb-5 mb-lg-0">
                ...
                <p class="mb-0">
                    Jln. Simpang IV Tanjung Bonai Aur
                    <br>Sumpur Kudus, Sijunjung
                </p>
            </div>
            <div class="col-md-4 mb-5 mb-lg-0">
                <ul class="list-inline mb-0">
            ...
            <div class="col-md-4">
                ...
                <p class="mb-0">
                    031-3095331 <br>
                    layananpengaduan@tanjungbonaiaur.go.id <br>
                    layananpengaduan.tanjungbonaiaur@gmail.com
                </p>
            </div>
        </div>
    </footer>
